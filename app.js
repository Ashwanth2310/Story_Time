...
function sweetTooth(totalNoOfSweets,sweetsConsumedByKaren,sweetsConsumedInMeters,metersToT)
{
    var remaining = (totalNoOfSweets-(sweetsConsumedByKaren+sweetsConsumedInMeters*metersToT))/2;
    return remaining;
}
